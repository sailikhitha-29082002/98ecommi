...
app.run(use_reloader=True,debug=True) #debug=True is for showing the errors on the page, use_reloader=True is for reflecting the changes directly instead of relaunching the server manually